...
!!! warning "Важно"
    При удалении компонента из конфигурации файлы НЕ удаляются автоматически.
    Удалите их вручную или используйте `--dry-run` для просмотра изменений.

1. Удалите компонент из `config.yaml`
2. Регенерируйте проект
3. Удалите неиспользуемые файлы вручную
